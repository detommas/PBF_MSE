...
HCR1a_pbf_byfleet_f <- function(ssout, dat, forf, yr, SSBtrs, SSBlim, err, Fmin, hs,hcr,scn,itr,tstep, yrb,yrf){
  ...
  #Note that discards are already accounted for by the specific fleet, this is an implementation error in addition to that
