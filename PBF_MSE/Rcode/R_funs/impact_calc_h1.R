...
impact_calc_h1 <- function(Dir,ssDir){
  ...
  epof <- c(20:23,26) #"EPO"
  wpof <- c(1:19,24,25) #"WPO"
  nof <- c(1:26) #nofishing 
  wposf <- c(8:10,12:16,25) #"WPOs"
  wpolf <- c(1:7) #"WPOl"
  wpomf <- c(11,17:19,24) #"WPOm"
  usf <- c(20,22,23,26) #"US"
  mxf <- c(21) #"Mexico"
  ...
  #save output to file
  write.table(SB_dif, paste(pdir,hs,hcr, scn,itr, "/impact",hsnum,hcrnum,snum,".txt", sep =""))
