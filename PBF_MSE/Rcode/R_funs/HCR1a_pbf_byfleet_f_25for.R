...
HCR1a_pbf_byfleet_f_25for <- function(ssout, dat, forf, yr, SSBtrs, SSBlim, err, Fmin, hs,hcr,scn,itr,tstep, yrb,yrf,tacl,is_hi_discard=FALSE, TACdt,TACEdt,TACWldt,TACWsdt, TACmat){
