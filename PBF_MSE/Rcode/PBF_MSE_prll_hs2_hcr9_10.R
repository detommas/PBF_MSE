...
foreach(itr = 1:100, .packages = c('r4ss','dplyr','reshape2', 'tidyverse')) %dopar% { PBF_MSE_hs2_910_for_sam24_ncmm(hsnum,hcrnum,scnnum,itr, Bthr = 0.20,sa=0,lag=1,obse=2,aspm=NULL,yfor=c(2015:2022),tacl=25)}
...
#Set the scenario
scnnum= 1
foreach(itr = 1:100, .packages = c('r4ss','dplyr','reshape2','tidyverse')) %dopar% { PBF_MSE_hs2_910_for_sam24_ncmm(hsnum,hcrnum,scnnum,itr, Bthr = 0.15,sa=0,lag=1,obse=2,aspm=NULL,yfor=c(2015:2022),tacl=25)}
