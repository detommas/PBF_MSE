...
png("ssb_wormp.png", width = 15, height = 10, units = 'in', res = 300)
ssbwp
dev.off()
...
ssbmat = data.frame(Year=c(rep(ssbdat$Year,12),dat3_ssbt$outmat.Year),
                    ...
                    hcr=c(rep(1,69),rep(2,69),rep(3,69),rep(4,69),
                          rep(5,69),rep(6,69),rep(7,69),rep(8,69),
                          rep(9,69),rep(10,69),rep(11,69),rep(12,69),
                          dat3_ssbt$hcr))
c12 <- c(
...
png("ssb95_omval.png", width = 10, height = 8, units = 'in', res = 300)
ssbplot95
dev.off()
...
dev.new(width=10, height=8)
png("dep95_omval.png", width = 10, height = 8, units = 'in', res = 300)
dplot95
dev.off()
...
dev.new(width=10, height=8)
png("f95_omval.png", width = 10, height = 8, units = 'in', res = 300)
fplot95
dev.off()
...
dev.new(width=10, height=8)
png("c95_omval.png", width = 10, height = 8, units = 'in', res = 300)
cplot95
dev.off()
...
dev.new(width=10, height=8)
png("rec95_omval.png", width = 10, height = 8, units = 'in', res = 300)
rplot95
dev.off()